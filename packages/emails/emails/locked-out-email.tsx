...
export default function LockedOutEmail() {
  return (
    <Html lang="no">
      ...
      <Preview>Du har fått for mange prikker.</Preview>
      ...
      >
        <Container className="mx-auto my-auto w-full max-w-[600px] px-4 py-8">
          ...
          <Text className="text-lg">
            Ettersom at du har fått for mange prikker, så vil du ikke ha mulighet til å melde deg på
            nye bedriftspresentasjoner.
          </Text>

          <Text className="pt-4">
            Hver prikk varer i 6 måneder, og du kan melde deg på nye bedriftspresentasjoner når du
            har færre enn 3 prikker.
          </Text>
