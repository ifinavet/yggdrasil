...
import { ORDER_CONTACT_EMAIL, OrderLayout } from "../components/order-layout.js";
...
export default function JobListingOrderRejectedEmail({
	...
	return (
		<OrderLayout preview="Bestillingen ble ikke publisert">
			...
			<Text>{`Svar på denne e-posten eller skriv til ${ORDER_CONTACT_EMAIL} hvis du har spørsmål.`}</Text>
		</OrderLayout>
	);
}
