...
import getResources from "@/lib/queries/bifrost/resource/getResources";
        ...
        <div key={tag} className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl">
            {resources.map((resource) => (
              <Link
                href={`/bifrost/resources/${resource.resource_id}`}
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl">
              {resources.unpublishedResources.map((resource) => (
                <Link
                  href={`/bifrost/resources/${resource.resource_id}/edit`}
                  key={resource.resource_id}
                >
                  <Card
                    key={resource.resource_id}
