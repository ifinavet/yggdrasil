...
export default function DateTimePicker({
    ...
    form: UseFormReturn<{
        ...
        food: string;
        location: string;
        organizers: { id: string; role: string }[];
        teaser: string;
        ...
        hostingCompany: { name: string; id: string };
    }>;
        ...
        <FormField
            ...
            render={({ field }) => (
                <FormItem className='flex flex-col'>
                    ...
                    <FormDescription>Velg nå arrangementet skal begynne.</FormDescription>
                    <FormMessage />
                </FormItem>
            )}
        />
