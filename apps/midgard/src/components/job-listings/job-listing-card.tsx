...
export default function JobListingCard({
	...
	return (
		<div
			key={listingId}
			className='flex h-[450px] w-80 flex-col overflow-clip rounded-lg bg-white shadow-md dark:bg-zinc-800'
		>
			<div
			...
			<div className='relative h-32 min-h-32 px-10 pt-6 dark:bg-zinc-100/95'>
			...
			<div className='flex flex-1 flex-col justify-between gap-6 px-8 pb-6'>
				...
				<Button asChild className="mt-4 text-primary-foreground dark:bg-primary-light dark:text-primary">
