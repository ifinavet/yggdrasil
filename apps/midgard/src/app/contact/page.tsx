  ...
  return (
    <ResponsiveCenterContainer>
      <TwoColumns
        ...
        aside={
          <LargeUserCard title="Studentkontakt" fullName={user.fullName ?? "ukjent"} email={user.primaryEmailAddress?.emailAddress ?? "styret@ifinavet.no"} imageUrl={user.imageUrl ?? ""} />
        }
      />
    </ResponsiveCenterContainer>
  );
