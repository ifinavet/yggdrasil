...
export default function DateTimePicker({
  ...
  const handleDateChange = (date: Date | undefined, currentValue: Date | undefined, onChange: (value: Date) => void) => {
    if (date) {
  ...
  const handleTimeChange = (timeValue: string, currentValue: Date | undefined, onChange: (value: Date) => void) => {
    if (timeValue) {
