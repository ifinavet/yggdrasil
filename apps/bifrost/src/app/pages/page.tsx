  ...
  try {
    ...
    return (
      <>
        ...
        <div className='flex flex-wrap gap-4'>
          {pages.map((page) => (
            <Link href={`/pages/${page.page_id}`} className='flex flex-col gap-6' key={page.page_id}>
              <Card>
                <CardHeader>
    ...
    return (
      <>
        ...
        <small className="text-sm leading-none font-medium">{(error as Error).message}</small>
      </>
    );
  }
}
