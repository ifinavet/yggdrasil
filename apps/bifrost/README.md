...
Follow the local development instructions in the [repository README](../../README.md). Run `pnpm dev` from the repository root to start all apps and the local backend. Bifrost runs at [http://localhost:3001](http://localhost:3001).
