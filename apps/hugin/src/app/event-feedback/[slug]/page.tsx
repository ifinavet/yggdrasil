					...
					<Card>
						...
						<CardContent className="space-y-6 text-center">
							<p className="text-muted-foreground">
								Tusen takk for at du tok deg tid til å svare. Du kan trykke på knappen under for å gå til din besvarelse
							</p>

							<Button asChild className="w-full">
								<Link href={`/event-feedback/${event.slug}/response`}>
	...
	return (
		<div className="mx-auto mb-8 max-w-3xl">
			<div className="prose dark:prose-invert max-w-[80ch] py-4 pb-8 prose-h1:text-primary dark:prose-h1:text-primary-foreground">
				<h1>Bedriftspresentasjon med {event.hostingCompanyName}</h1>
				<p>
